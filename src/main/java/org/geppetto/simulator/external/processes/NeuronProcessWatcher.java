 ...
 *
 */
public class NeuronProcessWatcher extends Thread
{
    private InputStreamReader _processStream = null;
    private String _type = null;    
	private static Log _logger = LogFactory.getLog(NeuronProcessWatcher.class);

    public NeuronProcessWatcher(InputStream processStream, String type)
    {
